...
public class ItemSerializer {
	...
	public static String asString(ItemStack item, LanguageManager manager, String language) {
		String result = (manager != null) ? (manager.translateMaterial(language, item.getType()))
