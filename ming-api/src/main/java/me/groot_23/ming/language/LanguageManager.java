...
public class LanguageManager {
	...
	public LanguageHolder addLanguageHolder(File languageFolder) {
		LanguageHolder langHolder = new LanguageHolder(defaultLanguage, languageFolder);
		langHolders.add(langHolder);
		return langHolder;
	}
